...
def listenSerialMonitor(conn, cursor, conn2, cursor2):
    ...
    while True:
        ...
        print(val)
        #print(val)
        print(parseString(val, cursor))
        info = parseString(val, cursor)
...
if __name__ == '__main__':
    ...
    #path = "E:\\University of Toronto\\FASE ESC Praxis III Teaching Team - 2022 Winter - Student Work - Team 1034A\\Design Milestones\\Prototype\\Back End\\ReleaseVersion\\database.db"
    #path2 = "E:\\University of Toronto\\FASE ESC Praxis III Teaching Team - 2022 Winter - Student Work - Team 1034A\\Design Milestones\\Prototype\\Back End\\ReleaseVersion\\missing.db"
    path = "database.db"
    path2 = "missing.db"
